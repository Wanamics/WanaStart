...
codeunit 87101 "WanaStart Import FR"
{
    ...
    begin
        case CsvBuffer."Field No." of
            ...
            //[
            // 19:
            //     ImportLine."External Document No." := CopyStr(CsvBuffer.Value, 1, MaxStrLen(ImportLine."External Document No."));
            // 20:
            //     ImportLine."Applies-to ID" := CopyStr(CsvBuffer.Value,1, MaxStrLen(ImportLine."Applies-to ID"));
            // 21:
            //     ImportLine."Shortcut Dimension 1 Code" := CsvBuffer.Value;
            // 22:
            //     ImportLine."Shortcut Dimension 2 Code" := CsvBuffer.Value;
            //]
            else
