...
// #if not CLEAN23
{
    ...
    begin
        ...
        // , "Dimension Set ID"
        //, "Starting Date", "Ending Date", "PDF URL"
        //]
        );
        ...
        // //[
        // wanVendorLedgerEntry.SetLoadFields("External Document No.", "Closed by Entry No.");
        // wanCustLedgerEntry.SetLoadFields("External Document No.", "Closed by Entry No.");
        // wanEmployeeLedgerEntry.SetLoadFields("Closed by Entry No.");
        OnAfterSetLoadFields(GLEntry);
        // //]
    end;
    ...
    begin
        ...
        'PieceDate|EcritureLib|Debit|Credit|EcritureLet|DateLet|ValidDate|Montantdevise|Idevise' + AppendHeaders() + CRLF);
        // '|ExternalDocumentNo|ClosedByEntryNo|Dim1|Dim2|Dim3|Dim4|Dim5|Dim6|Dim7|Dim8' + CRLF);
        //]
    end;
    ...
    begin
        ...
        //   GetFormattedDate(DT2Date(GLRegisterCreationDate)) + '|' +
          ...
          //[
          //CurrencyCode + CRLF);
          CurrencyCode + '|' + AppendColumns(GLEntry) + CRLF);
        //]
    end;
